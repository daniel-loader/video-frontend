(function(global, factory) {
    ...
    function getScrollParent(a) {
        return a === window.document
            ...
            : -1 !== ["scroll", "auto"].indexOf(getStyleComputedProperty(a, "overflow")) ||
              -1 !== ["scroll", "auto"].indexOf(getStyleComputedProperty(a, "overflow-x")) ||
              -1 !== ["scroll", "auto"].indexOf(getStyleComputedProperty(a, "overflow-y"))
        ...
        return (
            (c =
                a === b
                    ...
                    : { width: a.offsetWidth, height: a.offsetHeight, left: a.offsetLeft, top: a.offsetTop }),
    ...
    function setStyle(a, b) {
        Object.keys(b).forEach(function(c) {
            var d = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(c) && isNumeric(b[c]) && (d = "px"),
                (a.style[c] = b[c] + d);
        });
    }
    ...
    function getOffsets(a, b, c, d) {
        ...
        return (
            -1 === ["right", "left"].indexOf(d)
                ? ((e.left = i.left + i.width / 2 - j.width / 2), (e.top = "top" === d ? i.top - j.height : i.bottom))
                : ((e.top = i.top + i.height / 2 - j.height / 2), (e.left = "left" === d ? i.left - j.width : i.right)),
            (e.width = j.width),
            (e.height = j.height),
    ...
    function setupEventListeners(a, b, c, d) {
        if (
            ...
            (e === window.document.body || e === window.document.documentElement) && (e = window),
    ...
    function removeEventListeners(a, b) {
        return (
            ...
            b.scrollElement && b.scrollElement.removeEventListener("scroll", b.updateBound),
            (b.updateBound = null),
    ...
    function applyStyle(a) {
        ...
        return (
            a.instance.options.gpuAcceleration && e
                ? ((b[e] = "translate3d(" + c + "px, " + d + "px, 0)"), (b.top = 0), (b.left = 0))
                : ((b.left = c), (b.top = d)),
                ...
                var j = getPopperClientRect(a.offsets.popper),
                    ...
                    m =
                        ...
                        ((l && "start" === f && Math.floor(j.left) < Math.floor(c.left)) ||
                            ...
                            (!l && "end" === f && Math.floor(j.bottom) > Math.floor(c.bottom)));
                (k || m) &&
                    ((a.flipped = !0),
                    k && (d = g[i + 1]),
            ...
            -1 === a.placement.indexOf("left")
                ? -1 === a.placement.indexOf("right")
                    ? -1 === a.placement.indexOf("top")
                        ? -1 !== a.placement.indexOf("bottom") && ((d.left += e[0]), (d.top += e[1] || 0))
        ...
        var g = d.priority,
            ...
            i = {
                left: function left() {
                    var j = h.left;
                    return (
                        h.left < f.left && !shouldOverflowBoundary(c, d, "left") && (j = Math.max(h.left, f.left)),
                        { left: j }
                    );
                },
                ...
                top: function top() {
                    var j = h.top;
                    return (
                        h.top < f.top && !shouldOverflowBoundary(c, d, "top") && (j = Math.max(h.top, f.top)),
                        { top: j }
                    );
                },
    ...
    function shouldOverflowBoundary(c, d, e) {
        return (
            ...
            ((c.flipped && isSameAxis(c.originalPlacement, e)) || !!isSameAxis(c.originalPlacement, e) || !0)
        );
    }
    ...
    var Popper = (function() {
        function Popper(a, b) {
            ...
            return (
                ...
                c.modifiers &&
                    ((this.options.modifiers = Object.assign({}, DEFAULTS.modifiers, c.modifiers)),
                    ...
                    value: function update() {
                        ...
                        (this.state.position = getPosition(this.reference)),
                            ...
                            this.state.isDestroyed ||
                                ...
                                (a.offsets = getOffsets(this.state, this.popper, this.reference, a.placement)),
                                (a = runModifiers(this.modifiers, a)),
                                this.state.isCreated
                                    ? isFunction(this.state.updateCallback) && this.state.updateCallback(a)
                                    : ((this.state.isCreated = !0),
                                      isFunction(this.state.createCallback) && this.state.createCallback(a)));
                    }
                },
                {
                    key: "onCreate",
